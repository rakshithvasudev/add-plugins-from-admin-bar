...
Tags: admin, admin bar, shortcut to plugins, new plugin, 
...
== Screenshots ==
1. Drop-down Menu along with new integration to install plugins
2. after clicking it takes to the install page.
